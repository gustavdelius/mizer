...
plot(x=params@w_full, y=sim@n_d[years_run+1,], type="b",log="xy",xlab = "Size (g)", ylab="Abundance Of Dead Fish")
...
plot(x=params@w, y=sim@n[years_run,1,]*getFMort(sim@params, effort=1)[1,]*sim@params@discard_fraction[1,], type="b",log="xy", xlab = "Size (g)", ylab="Abundance Of New Discards")
plot(x=params@w, y=sim@n[years_run+1,1,]*getFMort(sim@params, effort=1)[1,]*sim@params@discard_fraction[1,], type="b",log="xy", xlab = "Size (g)", ylab="Abundance Of New Discards")
