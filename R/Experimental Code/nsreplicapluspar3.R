...
# do these work
# are they the same as mikes colum averages
# if not then maybe something was off about mrevious study, since we have seen NS
# landings, since exact ns model with either Fmat, or f_history, does not make anything
# like the landings data. What about if we use default rmax values instead, does this improve
# things ?
# we also need to figure out how to connect f_history and fmat
