...
# us rootSolve and multisolve to find self returning kappa values
# exactly for q=1.5, and Cval=1

##############
# seperate code for better solving for Cval using binary search (bisection algo)
