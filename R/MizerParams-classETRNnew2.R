...
setClass(
    ...
    prototype = prototype(
        ...
        psi2 = array(NA,dim = c(1,1), dimnames = list(sp = NULL,w = NULL)),
...
setMethod('MizerParams', signature(object='numeric', interaction='missing'),
	...
	res <- new("MizerParams",
	    ...
	    psi = mat1, psi2 = mat1, intake_max = mat1, search_vol = mat1, activity = mat1, 
