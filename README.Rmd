...
```
# This branch
In this branch I will develop the `tuneParams()` function that will start a
shiny gadget that allows the user to tune the model parameters while displaying
the consequences.
