...
knitr::opts_chunk$set(
  collapse = TRUE,
  comment = "#>",
  fig.path = "docs/dev/reference/figures/"
)
```
# This branch
Here I am working on a vignette describing the mathematical details behind the
numerical schemes in mizer, in particular the size discretisation and the
evaluation of the convolution integrals via FFT.
