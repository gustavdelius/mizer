...
```{r message=FALSE}
Red_mullet_cohort_analysis <- read_csv("inst/algarve/cohort_analysis/Red_mullet_cohort_analysis.csv")
Red_mullet_cohort_analysis
```
