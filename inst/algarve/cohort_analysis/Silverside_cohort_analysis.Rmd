...
```{r message=FALSE}
Silverside_cohort_analysis <- read_csv("inst/algarve/cohort_analysis/Silverside_cohort_analysis.csv")
Silverside_cohort_analysis
```
