# Setting up a mizer model for the Blanes system with
# a suprabenthos plankton spectrum
...
params <- MizerParams(species_params, interaction = theta,
...
params@initial_B <- c(detritus = 1, carrion = 1)
