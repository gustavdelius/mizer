...
lines(params@w,getEGrowth(params,sim@n[dim(sim@n)[1],,],sim@n_pp[dim(sim@n_pp)[1],])[1,])
...
plot(params@w,sim@n[dim(sim@n)[1],1,],log="xy")
lines(params@w,sol_mult*Njuv,col="red")
...
# neated/shorten code
# get match for second species too
# get solutions for all species
# add variable egg size ?
# extend to right
# extend to left
